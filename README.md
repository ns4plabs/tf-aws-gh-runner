...
| test-plans | linux | x64 | [m5.large](https://instances.vantage.sh/?selected=c5.4xlarge) | `github-runner-ubuntu-jammy-amd64-202212300856-kubo` built with [kubo.pkrvars](images/ubuntu-jammy/kubo.pkrvars.hcl) |
